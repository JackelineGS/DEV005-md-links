...
readFiles('C:\\Users\\user\\Desktop\\Laboratoria\\DEV005-md-links\\src\\documentos\\archivo.md')
  .then((rest) => request(rest).then((respuesta) => console.log(respuesta)));
